...
class SnakeExp:
    ...
    def send_motor_cmd(self, d=delay):
        ...
        temp_data = self.initial_angles_state+self.initial_strings_state+tuple(self.command.data)+self.final_angles_state+\
